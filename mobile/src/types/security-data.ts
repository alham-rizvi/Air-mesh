...
export interface Report { id: string; shelter_id: string; timestamp: string; people_count: number; needs: string[]; notes: string; severity: ReportSeverity; status: 'active' | 'resolved'; sync_status: ReportSyncStatus; origin_device_id: string; }
