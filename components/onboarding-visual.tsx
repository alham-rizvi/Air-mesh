...
function MeshMark({ size = 38 }: { size?: number }) {
  return <View style={{ width:0, height:0, borderLeftWidth:size*.5, borderRightWidth:size*.5, borderBottomWidth:size*.86, borderLeftColor:'transparent', borderRightColor:'transparent', borderBottomColor:'#FFFFFF' }} />;
}
