  ...
  return (
    <ScreenContainer edges={["top", "left", "right"]} containerClassName="bg-background">
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={[styles.beginnerCard, { backgroundColor: colors.field, borderColor: colors.border }]}>
          <View style={[styles.beginnerIcon, { backgroundColor: colors.surface, borderColor: colors.accent }]}><MaterialIcons name="shield" size={19} color={colors.accent} /></View>
          <View style={{ flex: 1 }}><Text style={[styles.micro, { color: colors.accent, fontFamily: DISPLAY_FONT }]}>NEW HERE? START IN THREE STEPS</Text><Text style={[styles.beginnerTitle, { color: colors.text }]}>Read the alert. Follow the guidance. Report safely.</Text><Text style={[styles.caption, { color: colors.muted }]}>You can use these tools now—no email, password, or account is required.</Text></View>
          <View style={styles.beginnerActions}><Pressable onPress={() => onNavigate?.("rescue")} style={[styles.beginnerAction, { borderColor: colors.border }]}><MaterialIcons name="health-and-safety" size={16} color={colors.accent} /><Text style={[styles.beginnerActionText, { color: colors.text }]}>Safety guide</Text></Pressable><Pressable onPress={() => onNavigate?.("report")} style={[styles.beginnerAction, { borderColor: colors.border }]}><MaterialIcons name="report" size={16} color={colors.accent} /><Text style={[styles.beginnerActionText, { color: colors.text }]}>Report incident</Text></Pressable><Pressable onPress={() => onNavigate?.("messages")} style={[styles.beginnerAction, { borderColor: colors.border }]}><MaterialIcons name="forum" size={16} color={colors.accent} /><Text style={[styles.beginnerActionText, { color: colors.text }]}>Offline chat</Text></Pressable></View>
        </View>
...
const styles = StyleSheet.create({
  ...
  beginnerCard: { borderWidth: 1, borderRadius: 18, padding: 14, marginTop: 14, flexDirection: "row", alignItems: "flex-start", gap: 10, flexWrap: "wrap" }, beginnerIcon: { width: 36, height: 36, borderRadius: 12, borderWidth: 1, alignItems: "center", justifyContent: "center" }, beginnerTitle: { fontSize: 14, lineHeight: 18, fontWeight: "900", marginTop: 4, marginBottom: 3 }, beginnerActions: { width: "100%", flexDirection: "row", gap: 7, marginTop: 3 }, beginnerAction: { flex: 1, minHeight: 42, borderWidth: 1, borderRadius: 12, alignItems: "center", justifyContent: "center", gap: 3, paddingHorizontal: 5 }, beginnerActionText: { fontSize: 10, fontWeight: "800", textAlign: "center" },
